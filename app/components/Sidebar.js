  ...
  return (
    <div className="col-md-2 sidebar bg-white shadow d-none d-md-block">
      <div className="row mt-4">
        <span className="fs-5 text-success mb-2 ms-3">
          {location[1] === '' ? 'HOME' : location[1].toUpperCase()}
        </span>
        <hr />
      </div>
      <div className="row">
        ...
        <div className="row m-0">
          <ul className="list-group px-3">
            <li className="list-group-item fs-6 ms-0 mb-3 border-0 p-0">
              <Link
                className={`text-decoration-none ${
                  props.location === '/' ? 'text-primary' : 'text-dark'
                }`}
                to="/"
              >
                <svg
            ...
            <li className="list-group-item fs-6 ms-0 mb-3 border-0 p-0">
              <Link
                className={`text-decoration-none ${
                  props.location === '/recovered' ? 'text-primary' : 'text-dark'
                }`}
                to="/recovered"
              >
                <svg
            ...
            <li className="list-group-item fs-6 ms-0 mb-3 border-0 p-0">
              <Link
                className={`text-decoration-none ${
                  props.location === '/deaths' ? 'text-primary' : 'text-dark'
                }`}
                to="/deaths"
              >
                <svg
